...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await evento.find()
            ...
            .populate('setor') // todos os atributos
            .populate('subsetor') // todos os atributos
...
controller.obterUm = async (req, res) => {
    try{
        ...
        let obj = await evento.findById(id)
...
controller.atualizar = async (req, res) => {
    try{
        ...
        let ret = await evento.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try{
        ...
        let ret = await evento.findByIdAndDelete(id)
